...
import { Component, ElementRef, ViewChild, AfterViewInit, Renderer2, Input, EventEmitter, Output } from '@angular/core';
...
export class AccordionComponent implements AfterViewInit {
  ...
  setTabIndex() {
    const interactiveElements = this.content.nativeElement.querySelectorAll('a, input, button, [tabindex], label');
